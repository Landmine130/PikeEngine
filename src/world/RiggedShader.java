...
public class RiggedShader extends Shader {
	...
	public static final int JOINT_INDEX_ATTRIBUTE_LOCATION = 3;
	public static final int BIAS_ATTRIBUTE_LOCATION = 4;
	public static final int WEIGHT1_ATTRIBUTE_LOCATION = 5;
	public static final int WEIGHT2_ATTRIBUTE_LOCATION = 6;
	public static final int WEIGHT3_ATTRIBUTE_LOCATION = 7;
	public static final int WEIGHT4_ATTRIBUTE_LOCATION = 8;
	...
	protected void bindVariableLocations(int program) {
		...
		glBindAttribLocation(program, JOINT_INDEX_ATTRIBUTE_LOCATION, "jointIndexes");
	...
	protected String vertexShaderName() {
		return "RiggedShader.vsh";
	}
	
	protected String fragmentShaderName() {
		return "RiggedShader.fsh";
	}
